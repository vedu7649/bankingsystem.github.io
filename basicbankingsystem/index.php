...
<html lang="en">
<head>
   <title>My Bank - Hamari Bank</title>
   <meta charset="utf-8">
...
<section class= "my-5" >
<div class="py-5" style="height: 80px;">
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>My Bank</h1>
      <p1> My Bank is a part of Vedant foundation. It is one of India's leading private banks and was among the first to receive approval from the Central bank of India (CBZ) to set up a private sector bank in 992 ZY.
          Today, My Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. My Bank offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<div class="py-5">
 ...
 <p1>This website is the
      ...
      acknowledged within the website. Anyone may reproduce, distribute, adapt, translate the content on the website, without explicit permission, provided that the content is accompanied by an acknowledgement that My Bank website is the source and that it is clearly indicated if changes were made to the original content.</p1>
 </div>



<footer class="text-center mt-2 py-5">
        <p>&copy 2022  <b>Vedant Sutar</b> </br>Vedant Foundation</p>
      </footer>
